...
/* old compile document function, TODO: remove this
function compile(obj) {
        if(!Array.isArray(obj)) {
                return document.createTextNode(obj); // assume it's a text node
        }
        ...
        if(len > 1) {
                ...
                if(typeof obj[1] === "object" && !Array.isArray(obj[1])) {
                        ...
                        for(let attrIdent of Object.keys(attrs)) {
                                elem.setAttribute(attrIdent, attrs[attrIdent]);
                        }
                }
        }
        ...
        for(let i = startValue; i < len; i++) {
                ...
                elem.append(compile(childObject));
        }
